...
export default function Home() {
  ...
  return (
    <section id='home' className="shadow-xl border-b-8 border-primary-light bg-background-light dark:bg-background-dark pt-32 min-h-[calc(100vh-60px)] flex flex-col-reverse md:flex-row items-center justify-center md:justify-between gap-10 px-6 md:px-20 lg:px-40 py-16">
      ...
      <div className="flex-1 text-center md:text-left space-y-6">
        ...
        >
          {language === 'en' ? '  Iam a Frontend Developer' : 'أنا مطورة واجهات أمامية'}
        </motion.h2>
        ...
        >
           {language === 'en' ? 'Transforming Ideas Into Interactive Designs And Powerful WebSite Experience' : 'أحوّل الأفكار إلى تصاميم تفاعلية وتجارب قوية لمواقع الويب'}
        ...
        >
          <a href="https://github.com/eman-aymanL" target="_blank"><FaGithub /></a>
          <a href="https://www.linkedin.com/in/eman-aymanl/" target="_blank"><FaLinkedin /></a>
          <a href="mailto:emanaymanoffical@gmail.com"><FaEnvelope /></a>
          <a href="https://wa.me/201154232694" target="_blank"><FaWhatsapp /></a>
        </motion.div>
